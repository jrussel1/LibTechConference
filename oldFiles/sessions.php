...
$(document).ready(function()
{
  $(".Event_ID").change(function()
	...
	$(".Event_ID2").change(function()
	  {
	  var id=$(this).val().split("_");
	  
	  var dataString = 'Event_ID='+ id[0];
...
<h1>Sessions</h1>
<? include("top-nav.php");	?>
<p>Select Session Utility.</p>
<form action="" method="post">
<select name="utility">
<option disabled="disabled" <?if(!isset($_POST['utility'])){echo("selected='selected'");}?>>Please select utility</option>
<option value="view" <?if(isset($_POST['utility'])&&$_POST['utility']=="view"){echo("selected='selected'");}?>>View Sessions</option>
<option value="add" <?if(isset($_POST['utility'])&&$_POST['utility']=="add"){echo("selected='selected'");}?>>Add a new Session</option>
<option value="edit" <?if(isset($_POST['utility'])&&$_POST['utility']=="edit"){echo("selected='selected'");}?>>Edit Sessions</option>
</select>
